...
const CARD_LIBRARY = {
  ...
  content: [
    ...
    // ✅ NEW VIDEO CARD ADDED HERE
    { name: "Video Card", html: `<div class="relative rounded-2xl overflow-hidden group cursor-pointer shadow-lg bg-black"><video src="https://www.w3schools.com/html/mov_bbb.mp4" class="w-full aspect-video object-cover opacity-80 group-hover:opacity-100 transition-opacity duration-500" autoplay muted loop playsinline></video><div class="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors flex items-center justify-center pointer-events-none"><div class="h-16 w-16 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center border border-white/30 group-hover:scale-110 transition-transform"><svg class="w-6 h-6 text-white fill-white ml-1" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg></div></div><div class="absolute bottom-4 left-4 text-white pointer-events-none"><h3 class="font-bold text-lg drop-shadow-md">Cinematic Intro</h3><p class="text-xs opacity-90 drop-shadow-md">2:14 • 4K Resolution</p></div></div>` },
